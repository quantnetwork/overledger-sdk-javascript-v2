...
const preparedTransaction = require('./bitcoin-prepared-transaction.json');
...
overledger.dlts[DltNameOptions.BITCOIN].setAccount({privateKey: process.env.PARTY_A_BITCOIN_PRIVATE_KEY});
